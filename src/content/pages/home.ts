...
export const homeContent = {
  ...
  intro: {
    text: "愛媛・中島という島で。築100年の古民家を2円で譲り受け、100本のレモンの木の手入れを任されました。",
    columns: [
      "愛媛・中島という島で。",
      "築100年の古民家を\n2円で譲り受け、",
      "100本のレモンの木の\n手入れを任されました。",
  ...
  shortProfile: {
    ...
    presentEyebrow: "2026 / NOW",
    presentQuote: "ゆるっと、でも軸を持って。",
    presentBody:
      "本業が忙しくなり、東京で過ごす時間も増えました。以前ほど中島へ通えない週もあります。それでも、島への思いは変わりません。暮らしや仕事を投げ出すのではなく、今の自分にできる範囲で地域と関わり続ける。これは片手間ではなく、私なりの本気の取り組みです。時間の許す限り、島の人や風景との関係を手入れしていきたいと思っています。",
  ...
  currentActivities: {
    ...
    kominka: {
      ...
      houseHeading: "一軒の家から、島全体へ。",
      houseBody: [
        "再生した古民家には、「しとらすすたんどKominKa」と名前をつけました。ただ、この場所を何と呼ぶべきか、その答えはまだ決まっていません。",
        "家は直したものの、制度上の事情もあり、すぐに店や施設として形にできるわけではありませんでした。だから今は、古民家へ人を集めることだけを目的にせず、島全体を活動の場として考えています。",
        "畑で手を動かし、海辺を掃除し、港から人を迎える。古民家は、その途中で休み、誰かを招いて話し、次にやりたいことを考えるための小さな拠点です。一軒の家から始まった活動は、少しずつ島全体へ広がっています。",
      ],
      image: placeholderImages.house,
